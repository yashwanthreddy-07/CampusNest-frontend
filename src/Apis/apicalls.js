...
export const getOwnerDetails = async () => {
  return callApi('get/owner-details', 'GET', null, localStorage.getItem('owner-token'));
};
...
export const getUserDetails = async () => {
  return callApi('get/user-details', 'GET', null, localStorage.getItem('user-token'));
};
export const createRoom = async (roomData) => {
  return callApi('create-room', 'POST', roomData, localStorage.getItem('owner-token'));
};

export const deleteRoom = async (roomData) => {
  return callApi('delete-room', 'DELETE', roomData, localStorage.getItem('owner-token'));
};

export const getOwnerRooms = async (roomData) => {
  return callApi('owner-rooms', 'GET', null, localStorage.getItem('owner-token'));
};
...
export const getNotifications = async (body) => {
  return callApi('get-notifications', 'POST', body, localStorage.getItem(`${body.role}-token`) );
};

export const updateprofile  = async (body) =>{
  return callApi('get/update-profile', 'PUT', body, localStorage.getItem(`user-token`) );
}
...
export const getUsersChat = async () => {
  return callApi('get-user-chats', 'GET', null, localStorage.getItem(`user-token`) );
};

export const getOwnerChat = async () => {
  return callApi('get-owner-chats', 'GET', null, localStorage.getItem(`owner-token`) );
};
